...
- **[Investment Research Agent](./investment_research_agent/)** Portfolio Assistant has three collaborators, a News agent, a Quantitative Analysis agent, and a Smart Summarizer Analyst. These specialists are orchestrated to perform investment analysis for a given stock ticker based on the latest news and recent stock price movements.
