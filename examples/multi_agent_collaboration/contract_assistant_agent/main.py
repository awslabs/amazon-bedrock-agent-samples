...
def main(args):
    ...
    contracts_assistant = SupervisorAgent.create(
        ...
        collaborator_objects=[general_contract_assistant, existing_contract_assistant, contract_drafting_agent],
        llm="us.anthropic.claude-3-5-sonnet-20241022-v2:0",
        verbose=False
        )
    ...
    if args.recreate_agents == "false":
        ...
        for request in requests:
            print(f"\n\nRequest: {request}\n\n")
            result = contracts_assistant.invoke(request, 
...
if __name__ == '__main__':
    ...
    parser.add_argument("--recreate_agents", required=False, default=True, 
                       help="False if reusing existing agents.")
    parser.add_argument("--clean_up", required=False, default=False, 
