...
class BedrockAgentStack(Stack):
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        embedding_model_arn = bedrock.FoundationModel.from_foundation_model_id(
            scope=self,
            _id="EmbeddingsModel",
            foundation_model_id=bedrock.FoundationModelIdentifier(embedding_model_id),
        ).model_arn
        ...
        bucket_deployment = s3_deploy.BucketDeployment(
            self,
            "Deploycontent",
            sources=[s3_deploy.Source.asset("./dataset")],
        ...
        datasource = bedrock.CfnDataSource(
            ...
            data_source_configuration={
                "s3Configuration": {"bucketArn": s3Bucket.bucket_arn},
                "type": "S3",
            },
        ...
        s3Bucket.add_event_notification(
            s3.EventType.OBJECT_CREATED, s3n.LambdaDestination(kb_sync_lambda)
        )
        s3Bucket.add_event_notification(
            s3.EventType.OBJECT_REMOVED, s3n.LambdaDestination(kb_sync_lambda)
        )
        ...
        dynamodbable = dynamodb.Table(
            self,
            config["dynamodbTableId"],
        ...
        action_group_function = lambda_.Function(
            ...
            runtime=lambda_.Runtime.PYTHON_3_12,
            code=lambda_.Code.from_asset("lambda/actiongroup"),
            handler="lambda_function.lambda_handler",
            timeout=Duration.seconds(300),
        )
        action_group_function.add_to_role_policy(
            iam.PolicyStatement(
                sid="UpdateDynamoDB",
                effect=iam.Effect.ALLOW,
                        ...
                        functions=[
                            ...
                            bedrock.CfnAgent.FunctionProperty(
                                ...
                                parameters={
                                    ...
                                    config[
                                        "func_createbooking_person_name"
                                    ]: bedrock.CfnAgent.ParameterDetailProperty(
                                        type="string",
                                        # the properties below are optional
