...
def lambda_handler(event, context):
    ...
    if actionGroup == "RequestTimeOff":
        ...
        return create_success_function_response(event, create_employee_time_off_request(event))
    elif actionGroup == "GetTimeOff":
        print('Got action group: GetTimeOffBalance')
        return create_success_function_response(event, get_employee_time_off_balance(user_id))
    else:
