                    ...
                    function_schema=bedrock.CfnAgent.FunctionSchemaProperty(
                        functions=[
                            ...
                            bedrock.CfnAgent.FunctionProperty(
                                ...
                                parameters={
                                    config['func_createtimeoff_start_date']: bedrock.CfnAgent.ParameterDetailProperty(
                                        type="string",
                                    ...
                                    config['func_createtimeoff_number_of_days']: bedrock.CfnAgent.ParameterDetailProperty(
                                        type="integer",
