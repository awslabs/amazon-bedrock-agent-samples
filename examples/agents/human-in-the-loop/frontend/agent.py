...
def Parse_Roc_Response(payload):
    ...
    if 'apiInvocationInput' in invocation_inputs[0]:
        params = invocation_inputs[0]["apiInvocationInput"]["requestBody"]["content"]["application/json"]["properties"]
        ...
        final_resp["httpMethod"] = invocation_inputs[0]["apiInvocationInput"]["httpMethod"]
        final_resp["actionGroup"] = invocation_inputs[0]["apiInvocationInput"]["actionGroup"]
        ...
        final_resp['invocationId'] = payload["returnControl"]["invocationId"]
        final_resp['actionGroup'] = invocation_inputs[0]["functionInvocationInput"]["actionGroup"]
